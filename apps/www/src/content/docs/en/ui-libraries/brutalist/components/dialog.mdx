...
<div style="--pui-radius:0;--pui-background:#f4f1ea;--pui-secondary-background:#fff;--pui-foreground:#000;--pui-border:#000;--pui-sky:#BAE6FD;--pui-canary:#FEF08A;--pui-coral:#FECDD3;background:#f4f1ea;color:#000;border:2px solid var(--pui-foreground);box-shadow:3px 3px 0 var(--pui-foreground);padding:1rem;">

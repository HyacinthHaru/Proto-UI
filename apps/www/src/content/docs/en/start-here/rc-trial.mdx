...
export const multiHostFiles = /** @type {const} */ ({
  react: [
    {
      name: 'install.sh',
      lang: 'bash',
      code: 'npx @proto.ui/cli@0.2.0-rc.7 add react shadcn-button',
    },
    {
      name: 'Demo.tsx',
      lang: 'tsx',
  ...
  wc: [
    {
      name: 'install.sh',
      lang: 'bash',
      code: 'npx @proto.ui/cli@0.2.0-rc.7 add wc shadcn-button',
    },
    {
      name: 'main.ts',
      lang: 'typescript',
      code: "import { ShadcnButtonElement } from '../proto-ui/components/wc';",
    },
  ],
});
...
<CodeExample files={multiHostFiles} initialHost="react" label="React and Web Component setup" />
